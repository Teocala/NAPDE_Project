function [dphiq,Grad,B_edge,G_edge]=evalshape_tria_dubiner(shape_basis,node_1D, node_2D,nqn,nln)
    ...
    for i=0:(deg)
        if (i+j) <= deg
           s=s+1;
            ...
            % gradienti delle funzioni di base - seconda componente
        end
    end
end

%=========================================================
% VALUTAZIONE DELLE FUNZIONI DI BASE SUI LATI
%=========================================================
