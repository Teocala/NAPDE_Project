...
\end{equation}
 ...
 & \bullet \quad T_n := \frac{\chi_mC_m}{\Delta t}MV_m^n + \frac{2\chi_m}{1+2\epsilon\gamma\Delta t}M w^n
 \end{aligned}
 \end{gathered}
\end{equation}
...
\begin{enumerate}
	...
	\chi_m C_m M \frac{	\Phi_i^{n+1}-\Phi_e^{n+1}-V_m^{n}}{\Delta t} + 2\cdot C(V_m^n) (\Phi_i^{n+1}-\Phi_e^{n+1}) + \\ - 2 \chi_m M \left(\frac{w^n + 2\epsilon \Delta t (\Phi_i^{n+1}-\Phi_e^{n+1})}{1+2\epsilon \gamma \Delta t}   \right) + A_i \Phi_i ^{n+1} = F_i^{n+1} \\ \\
     \Rightarrow \quad (Q_n + A_i) \Phi_i^{n+1} - Q_n \Phi_e^{n+1} =T_n +  F_i^{n+1}
	\end{gathered}
	\end{equation}
	...
	\Rightarrow \quad Q_n \Phi_i^{n+1} - (Q_n+A_e) \Phi_e^{n+1} =T_n + F_e^{n+1}
	\end{gathered}
	\end{equation}
	\vspace{3mm}
	\item 
...
\end{bmatrix}
= \begin{bmatrix} T_n \\ T_n \end{bmatrix} + \begin{bmatrix} F_i^{n+1} \\  F_e^{n+1}\end{bmatrix} \\ \\
...
T_n := \frac{\displaystyle \chi_mC_m}{\displaystyle \Delta t}MV_m^n + \frac{\displaystyle 2\chi_m}{\displaystyle 1+2\epsilon\gamma\Delta t}M w^n \\ \\
...
w^{n+1} = (1-\epsilon \gamma \Delta t) w^n + \epsilon V_m^n
\end{cases}
\\ \\  \\
\Rightarrow
\begin{cases}
