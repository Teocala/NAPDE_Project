...
function [errors]= compute_errors_Vm(Dati,femregion,solutions,S,t)
% [errors]= compute_errors_Vm(Dati,femregion,solutions,S,t)
%==========================================================================
% Compute L2, H1, DG and L-inf errors for TRANSMEMBRANE POTENTIAL
%==========================================================================
%    called in main2D.m
%
%    INPUT:
