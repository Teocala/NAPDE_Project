function [ f ] = assemble_rhs_i(femregion,neighbour,Data,t)
%% [f] =  assemble_rhs_e(femregion,neighbour,Data,t)
%==========================================================================
% Assembly the rhs for the equation associated to the intracellular
% potential
%==========================================================================
%    called in main2D.m
%
