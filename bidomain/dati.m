...
if test=='Test1' % Test for wave front simulation (applied currents)
    DATA = struct( 'name',          test,...
               ...
               'source_i',           '250*10^3*(t>=0.001).*(t<0.002).*(x>0.0045).*(x<0.0055).*(y>0.0045).*(y<0.0055)',...
               ... % Forcing term in time intracelluar            
               'source_e',           '250*10^3*(t>=0.001).*(t<0.002).*(x>0.0045).*(x<0.0055).*(y>0.0045).*(y<0.0055)',...    
