...
if test=='Test1' % test con parametri fisiologici 
...
elseif test=='Test2' % test con parametri FitzHugh-Nagumo fisiologici 
    DATA = struct( 'name',          test,...
               ... % Test name
               'method',              'SI',...
               ... % Set time discretization (SI, OS, GO)
...
elseif test=='Test3' % test con parametri unitari 
DATA = struct( 'name',             test,...
               ... % Test name
               'method',              'SI',...
               ... % Set time discretization (SI, OS, GO)
...
elseif test=='Test4' % test con parametri fisiologici / correzione per well-posedness
    DATA = struct( 'name',          test,...
               ... % Test name
               'method',              'SI',...
               ... % Set time discretization (SI, OS, GO)
