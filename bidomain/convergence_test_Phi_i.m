function convergence_test_Phi_i(TestName,nRef)
%        CONVERGENCE TEST FOR INTRACELLULAR POTENTIAL in norms: L2,
%        semi-H1, H1, DG, Inf
%              usage:   convergence_test_Phi_i('Test1',[2 3 4 5]) 
    ...
    for i=1:num_tests
        ...
        err_L2(i)=errors_i.E_L2;
        err_H1(i)=errors_i.E_H1;
        err_DG(i)=errors_i.E_DG;
        err_inf(i)=errors_i.E_inf;
        h(i)=femregion.h;
%         condA(i)=Data.condA;
    end
    close all
   ...
   % loglog(h , err_L2(1)*h/h(1), 'k-', 'linewidth', 2)
    ...
    title ('convergence test for intracellular potential')
