function [solutions]= postprocessing_Vm(femregion,Dati,u_h,t)
%% [solutions]= postprocessing_Vm(femregion,Dati,u_h,t)
%==========================================================================
...
title('u_h(x,y) - TRANSMEMBRANE POTENTIAL - Vm'); xlabel('x-axis'); ylabel('y-axis');
