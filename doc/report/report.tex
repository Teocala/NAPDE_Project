...
\begin{itemize}
	...
	\item Conditional numbers turn to be considerably decreased as we can see in Table \ref{tab_cond} where we compare the conditional number of $B+C_{nl}$ of the equation (\ref{SI-system}) at $t=0.0001$, applying the Dubiner basis with first polynomial degree and Semi-implicit method for the time discretization. 
\end{itemize}
\vspace{2mm}
\begin{center}
	\captionof{table}{Conditional number of $B+C_{nl}$ at $t=0.0001$}\label{tab_cond}
