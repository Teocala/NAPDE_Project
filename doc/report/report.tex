...
\subsubsection{P1-D1}
If $1$ is chosen as polynomial order, the errors plots are the following. 
...
\newpage
\newgeometry{a4paper,top=1cm,bottom=2cm,left=1cm,right=1cm} 
\begin{figure}[h] \caption{Test-case 1, activation ($I = 700 \cdot 10^3$)}
	\centering
	\begin{subfigure}{0.4\textwidth}
...
\newpage
\newgeometry{a4paper,top=1cm,bottom=2cm,left=1cm,right=1cm} 
\begin{figure}[h] \caption{Test-case 2, missed activation ($I = 15000 \cdot 10^3$)} \label{tc2-1}
	\centering
	\begin{subfigure}{0.4\textwidth}
...
\newpage
\newgeometry{a4paper,top=1cm,bottom=2cm,left=1cm,right=1cm} 
\begin{figure}[h] \caption{Test-case 2, activation ($I = 20000 \cdot 10^3$)} \label{tc2-2}
	\centering
	\begin{subfigure}{0.4\textwidth}
