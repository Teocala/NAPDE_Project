...
\begin{theo}
	For the Bidomain problem coupled with Fitzhugh-Nagumo model with Neumann boundary conditions (Problem (\ref{def1})), the solutions $\phi_i,\phi_e$ are unique up to a constant depending only on time. 
\end{theo}
...
On the other hand, it has already been stated that some peculiar problems can be solved only using the second method. Indeed, there could be huge differences for the solution or the system may even be not solvable because of a null, or almost null, determinant. These problems will be considered in Section (\ref{real_sim}) about physical simulations. However, since there is no known analytical solution for these problems, we cannot make now an error analysis like the previous one.\\ \\
...
\begin{itemize}
	...
	\item $I = 600 \cdot 10^3 $ is a suitable value for the \emph{overflow} case.
\end{itemize}

\noindent Visual results are the following:
\newpage
\begin{figure}[h] \caption{Test-case 1, missed activation ($I=500 \cdot 10^3$)}
	\centering
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-1/002.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-1/004.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-1/006.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-1/008.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-1/010.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-1/012.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-1/014.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-1/016.jpg}
	\end{subfigure}
\end{figure}
\newpage
\begin{figure}[h] \caption{Test-case 1, activation ($I = 600 \cdot 10^3$)}
	\centering
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-2/002.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-2/004.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-2/006.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-2/008.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-2/010.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-2/012.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc1-2/014.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc1-2/016.jpg}
	\end{subfigure}
\end{figure}
...
\newpage
\begin{figure}[h] \caption{Test-case 2, missed activation ($I = 15000 \cdot 10^3$)}
	\centering
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-1/004.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-1/012.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-1/020.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-1/028.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-1/036.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-1/044.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-1/052.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-1/060.jpg}
	\end{subfigure}
\end{figure}

\newpage
\begin{figure}[h] \caption{Test-case 2, activation ($I = 20000 \cdot 10^3$)}
	\centering
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-2/004.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-2/012.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-2/020.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-2/028.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-2/036.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-2/044.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width = 5cm]{./tc2-2/052.jpg}
	\end{subfigure}
	\begin{subfigure}{0.4\textwidth}
		\includegraphics[width =5cm]{./tc2-2/060.jpg}
	\end{subfigure}
\end{figure}
