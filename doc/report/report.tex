...
\noindent The implementation can be found at the Section (\ref{SI}).
\vspace{4mm}
...
\noindent The implementation is written at the Section (\ref{GO}).
\vspace{4mm}
...
\end{problem}
\vspace{4mm}
\noindent The implementation is at the Section (\ref{OS}).
\newpage
