...
\newpage
\section{Space error analysis results} \label{error_analysis}
\subsection{Chosen data}
...
\begin{center}
	\captionof{table}{Parameters for space error analysis simulations}
	\begin{tabular}{|c|c|} 
		\hline 
		\rule[-4mm]{0mm}{1cm}
...
\begin{center}
\underline{Comparison between Dubiner and FEM with first order polynomials}
\end{center}
...
\newgeometry{a4paper,top=4cm,bottom=4cm,left=2cm,right=2cm}
\begin{figure}[H]
...
\newgeometry{a4paper,top=3cm,bottom=3cm,left=2cm,right=2cm}
\begin{center}
\underline{Comparison between Dubiner and FEM with second order polynomials}
\end{center}
\begin{figure}[H]
\caption{Comparison of the trans-membrane potential ($V_m$)}
\label{Vm_2}
...
\newgeometry{a4paper,top=3cm,bottom=3cm,left=2cm,right=2cm}
\begin{center}
\underline{Comparison between Dubiner and FEM with third order polynomials}
\end{center}
\begin{figure}[H]
\caption{Comparison of the trans-membrane potential ($V_m$)}
\label{Vm_3}
...
In Section (\ref{temporal_discretization}) three methods for the time discretization have been proposed and discussed. An error analysis comparison has been executed and gives the graphical results shown in Fig. (\ref{Vm-time}), Fig. (\ref{pi-time}), Fig. (\ref{pe-time}) and Fig. (\ref{w-time}).
...
\begin{center}
\underline{Comparison between different time-discretization schemes}
\end{center}
\begin{figure}[h]
\caption{Comparison of the trans-membrane potential ($V_m$)}
\label{Vm-time}
...
\newgeometry{a4paper,top=3cm,bottom=3cm,left=2cm,right=2cm}
\begin{center}
\underline{Comparison between the uniqueness imposition strategies}
\end{center}
\begin{figure}[H]
\caption{Comparison of the trans-membrane potential ($V_m$)}
\label{Vm-unique}
